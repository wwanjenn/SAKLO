...
public final class ActivityNavBarBinding implements ViewBinding {
  ...
  private ActivityNavBarBinding(@NonNull FrameLayout rootView,
  ...
  public static ActivityNavBarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_nav_bar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityNavBarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNavBarBinding((FrameLayout) rootView, bottomNav);
    }
